  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.title,
          // widget.{data} : state가 상위의 stateful widget에 속한 data를 받아오는 방법
          // stateless 에서는 그대로 써도 되나, stateful이 되면서 별개의 class가 되므로..
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Hero(
                    // 화면을 전환할때 애니메이션을 제공 (기존 포스터가 새로운 화면으로 이동하는 것처럼 보이게..)
                    tag: widget.id,
                    child: Container(
                      width: 250,
